...
\midrule
2016 & 7765 & 6053 & 134 & 3658 & 5972 & 10251 & 51227\\
...
\item
  independent variable: ((distance/average distance)-1)*100 = our
  measure

  \begin{itemize}
  \tightlist
  \item
    Reason for normalizing: Summaries between years differ on average
    very little. Difference may be due to small changes in 10-K and
    preprocessing with Gemini. Makes the interpretation easy.
  \item
    Interpretation: If a companies BM changes 1 percentage point more
    than the market's average, the company has a x percentage points
...
Li, and Yang 2018). We use fixed effects for the year and our BERTScore
industry classification. In the robustness check we use the SIC codes
instead of our BERTScore industry classification. We do not control for
economical and political environment as White et al. (2022) suggests
since all of our companies are U.S. based companies.
...
Average distance = 0.103999 and standard deviation = 0.2681622
