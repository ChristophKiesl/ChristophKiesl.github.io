...
Table1 = read.csv("./TableData/Table1.csv", header=FALSE,sep=",")%>%
  ...
  kable(align = 'c',col.names = c("Source/Filter","Sample Size","Observations Removed"), booktabs = T)%>%
...
Table2 = read.csv("./TableData/Table2.csv")%>%
    kable(align = 'c',col.names = c("Report for Year","Average Word Count","Standard Deviation","Minimum","25th Percentile","Median","75th Percentile","Maximum"))%>%
