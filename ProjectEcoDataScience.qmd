...
Figure1_2 = Figure1_2_dat%>%
  ...
  annotate("text", x=0.2, y=15, label=paste("Mean_SC: ", round(desk_dat$Mean[desk_dat$FirmSize=="Small_Cap"], 4)), angle=0, size= 4)+
  # geom_vline(xintercept=desk_dat$Mean[desk_dat$FirmSize=="Mid_Cap"],alpha=0.5)+
  annotate("text", x=0.2, y=14, label=paste("Mean_MC: ", round(desk_dat$Mean[desk_dat$FirmSize=="Mid_Cap"], 4)), angle=0, size= 4)+
  # geom_vline(xintercept=desk_dat$Mean[desk_dat$FirmSize=="Large_Cap"],alpha=0.5)+
  annotate("text", x=0.2, y=13, label=paste("Mean_LC: ", round(desk_dat$Mean[desk_dat$FirmSize=="Large_Cap"], 4)), angle=0, size= 4)+
  scale_fill_manual(
