...
However, this is not the case. One possible explanation is that Tobin’s Q depends not only on market value but also on the firm’s assets. These assets may also increase following changes in the business model, as expenses often rise after such adjustments (https://www.emerald.com/insight/content/doi/10.1108/10878570710833714/full/html). Additionally, stock traders, particularly since the 2008 financial crisis, have tended to exhibit greater risk aversion. This could explain the negative coefficient (https://www.sciencedirect.com/science/article/abs/pii/S0304405X18300461).
...
Figure1_2 = Figure1_2_dat%>%
  ...
  annotate("text", x=0.2, y=15, label=paste("Mean Small Caps: ", round(desk_dat$Mean[desk_dat$FirmSize=="Small_Cap"], 4)), angle=0, size= 4)+
  # geom_vline(xintercept=desk_dat$Mean[desk_dat$FirmSize=="Mid_Cap"],alpha=0.5)+
  annotate("text", x=0.2, y=14, label=paste("Mean Mid Caps: ", round(desk_dat$Mean[desk_dat$FirmSize=="Mid_Cap"], 4)), angle=0, size= 4)+
  # geom_vline(xintercept=desk_dat$Mean[desk_dat$FirmSize=="Large_Cap"],alpha=0.5)+
  annotate("text", x=0.2, y=13, label=paste("Mean Large caps: ", round(desk_dat$Mean[desk_dat$FirmSize=="Large_Cap"], 4)), angle=0, size= 4)+
  scale_fill_manual(
