...
The reasons why the effect is significant only for smaller companies could be numerous. One explanation is that larger firms have more extensive product portfolios, making new models or products less impactful. Additionally, changes in larger companies may take longer to implement, as more processes are involved.
