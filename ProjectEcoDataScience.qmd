...
\hspace*{-6cm}
\begin{array}{@{}l}
\text{(1) Sales Growth} = \left(\frac{\text{Revenue in year } t}{\text{Revenue in year } t-1} - 1\right) \times 100
\\[0.5cm]
\text{(2) Tobin's Q Growth} = \left(\frac{\text{Tobin's Q in year } t}{\text{Tobin's Q in year } t-1} - 1\right) \times 100
\\[0.5cm]
\text{for } t \in \{2017;2023\}
\end{array}
$$
