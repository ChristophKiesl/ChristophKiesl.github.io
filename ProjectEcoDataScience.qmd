...
To check the validity of the summaries generated by Gemini, we took a random sample of ten filings to evaluate them manually. We evaluated the summaries according to the criteria “Accuracy” (how well does the summary reflect the unabridged content), “Relevance” (how relevant is the information from the summary) and “Coherence” (is the summary logically structured and comprehensible). We use a rating scale from one to ten. The results are shown in Table 7.
