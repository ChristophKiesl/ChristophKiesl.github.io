...
#Revenue Growth
Reg1 = felm(RevenueGrowth~NormalizedDistance + log(MV) | sic * Industry | 0 | 0 ,data=RegressionData)
Reg2 = felm(RevenueGrowth~NormalizedDistance + log(Total.Assets) | sic * Industry | 0 | 0 ,data=RegressionData)

#Tobin's Q
#Reg3 = felm(RevenueGrowth~NormalizedDistance + log(Market_Value) | sic + Industry | 0 | 0 ,data=RegressionData)
#Reg4 = felm(RevenueGrowth~NormalizedDistance + log(Market_Value) | sic * Industry | 0 | 0 ,data=RegressionData)

stargazer(Reg1, Reg2, title= "Results", column.labels=c("default","robust"), header = FALSE)
```
...
#Sales Growth
Reg1Appendix = felm(RevenueGrowth~NormalizedDistance + log(MV) | year * Industry | 0 | 0 ,data=RegressionData)
Reg2Appendix = felm(RevenueGrowth~NormalizedDistance + log(Total.Assets) | year * Industry | 0 | 0 ,data=RegressionData)

#Tobin's Q
#Reg5Appendix = felm(RevenueGrowth~NormalizedDistance + log(MV) | year + Industry | 0 | 0 ,data=RegressionData)
#Reg6Appendix = felm(RevenueGrowth~NormalizedDistance + log(Total.Assets) | year * Industry | 0 | 0 ,data=RegressionData)

stargazer(Reg1Appendix,Reg2Appendix,header = FALSE)
```
