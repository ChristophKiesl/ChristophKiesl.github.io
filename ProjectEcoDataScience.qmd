...
Table1 = read.csv("./TableData/Table1.csv")%>%
    kable(col.names = c("Year","Mean","Standard Deviation","Minimum","25th Percentile","Median","75th Percentile","Maximum"))
...
Table2 = read.csv("./TableData/Table2.csv", header=FALSE,sep=",")%>%
  ...
  kable(col.names = c("Source/Filter","Sample Size","Observations Removed"))%>%
...
(Still preliminary) Regarding H2: Medium Homogeneity with 0.63 and Medium Completeness with 0.6026; Low Adjusted Rand Index (ARI) with 0.0002 and low Fowlkes-Mallows Index (FMI) -> indicates clusters are not better than random; No support for H2; Reason could be different object of investigation (BM vs product description)
...
Figure1 = Figure1 %>%
  ...
  geom_histogram(alpha = 1, bins = 50, col="white") +
