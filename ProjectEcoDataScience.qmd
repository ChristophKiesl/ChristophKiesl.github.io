...
```{r}
#$$
#NormalizedDistance = (Distance_i / Mean(Distance) - 1) \cdot 100
#$$
```

\[
\text{NormalizedDistance} = \left( \frac{\text{Distance}_i}{n^{-1} \sum_{t=0}^{n-1} \text{Distance}_i} - 1 \right) \cdot 100
\]
